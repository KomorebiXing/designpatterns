package com.sjms.wq.结构型.适配器模式与外观模式.demothrer.adapter;

import com.sjms.wq.结构型.适配器模式与外观模式.demothrer.Player;
import com.sjms.wq.结构型.适配器模式与外观模式.demothrer.Translator;
