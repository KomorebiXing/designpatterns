package com.sjms.wq.结构型.适配器模式与外观模式;

import com.sjms.wq.结构型.适配器模式与外观模式.demoone.TurkeyAdapter;
import com.sjms.wq.结构型.适配器模式与外观模式.demoone.bo.MallardDuck;
import com.sjms.wq.结构型.适配器模式与外观模式.demoone.bo.WildTurkey;
import com.sjms.wq.结构型.适配器模式与外观模式.demoone.interfaces.Duck;
import com.sjms.wq.结构型.适配器模式与外观模式.demoone.interfaces.Turkey;
import com.sjms.wq.结构型.适配器模式与外观模式.demothrer.MoviePlayer;
import com.sjms.wq.结构型.适配器模式与外观模式.demothrer.adapter.JPMoviePlayerAdapter;
import com.sjms.wq.结构型.适配器模式与外观模式.demothrer.adapter.Zh_JPTranslator;
import com.sjms.wq.结构型.适配器模式与外观模式.demotwo.bo.Amplifler;
import com.sjms.wq.结构型.适配器模式与外观模式.demotwo.bo.DdPlayer;
import com.sjms.wq.结构型.适配器模式与外观模式.demotwo.bo.DvdPlayer;
import com.sjms.wq.结构型.适配器模式与外观模式.demotwo.bo.HomeTheaterFacade;
import com.sjms.wq.结构型.适配器模式与外观模式.demotwo.bo.PopcomPopper;
import com.sjms.wq.结构型.适配器模式与外观模式.demotwo.bo.Projector;
import com.sjms.wq.结构型.适配器模式与外观模式.demotwo.bo.Screen;
import com.sjms.wq.结构型.适配器模式与外观模式.demotwo.bo.TheaterLights;
import com.sjms.wq.结构型.适配器模式与外观模式.demotwo.bo.Tuner;
