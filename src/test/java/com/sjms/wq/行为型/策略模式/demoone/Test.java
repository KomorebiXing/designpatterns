package com.sjms.wq.行为型.策略模式.demoone;

import com.sjms.wq.行为型.策略模式.demoone.bo.Duck;
import com.sjms.wq.行为型.策略模式.demoone.bo.MallardDuck;
import com.sjms.wq.行为型.策略模式.demoone.bo.ModelDuck;
import com.sjms.wq.行为型.策略模式.demoone.bo.RedheadDuck;
import com.sjms.wq.行为型.策略模式.demoone.bo.RubberDuck;
import com.sjms.wq.行为型.策略模式.demoone.interfaces.iml.FlyRocketPowered;
