package com.sjms.wq.行为型.观察者模式.demoone;

import com.sjms.wq.行为型.观察者模式.demoone.bo.CurrentConditionsDispaly;
import com.sjms.wq.行为型.观察者模式.demoone.bo.ForecastDisplay;
import com.sjms.wq.行为型.观察者模式.demoone.bo.WeatherData;
